...
// samples) output: leard PDAG_nishikori_PC
...
struct PDAG_nishikori_PC {
  ...
  // コピーコンストラクタ
  PDAG_nishikori_PC(const PDAG_nishikori_PC &old) {
    // cout << "copy constructor called" << endl;
    g = old.g;
  }
  // 代入演算子
  PDAG_nishikori_PC &operator=(const PDAG_nishikori_PC &a) {
    if (this != &a) g = a.g;
    return *this;
  }
  // デストラクタ
  ~PDAG_nishikori_PC() = default;
