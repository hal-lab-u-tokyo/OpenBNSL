...
// // samples) output: leard PDAG_nishikori_2
...
//   }
//   // コピーコンストラクタ
//   PDAG_nishikori_2(const PDAG_nishikori_2 &old) {
//     // cout << "copy constructor called" << endl;
//     g = old.g;
//   }
//   // 代入演算子
//   PDAG_nishikori_2 &operator=(const PDAG_nishikori_2 &a) {
//     if (this != &a) g = a.g;
//     return *this;
//   }
//   // デストラクタ
//   ~PDAG_nishikori_2() = default;
...
// vector<vector<int>> state_count_PC(const vector<vector<int>> &data, int
// &node_x,
//                                    vector<int> &parents,
//                                    vector<int> &n_states) {
//   if (parents.empty()) {
...
//       for (int k = 0; k < r; k++) {  // for each state of node_x
//         score +=
//             lgamma(ESS / (r * q) + count.at(k).at(j)) - lgamma(ESS / (r *
//             q));
//         if (isnan(score)) {
...
// void orientation(PDAG_nishikori_2 &Gall, const vector<vector<int>> &data,
// double &ESS,
//                  vector<int> &n_states) {
//   /*
//       orient edges in a PDAG_nishikori_2 to a maximally oriented graph.
...
// PDAG_nishikori_2 PCsearch(const vector<vector<int>> &data, PDAG_nishikori_2
// &Gall, double &ESS,
//                vector<int> &n_states) {
...
//               }
//               if (ci_test_PC(data, node_x, node_y, selected_z, ESS,
//               n_states)) {
//                 Gall.remove_edge(node_x, node_y);
//                 Gall.remove_edge(node_y, node_x);
//               }
...
// // void RAI(const vector<vector<int>> data, double ESS,vector<vector<bool>>
// g) { py::array_t<bool> PC_nishikori(py::array_t<int> data, py::array_t<int>
// n_states,
//                      double ESS) {
