...
vector<vector<int>> state_count_PC(const vector<vector<int>> &data, int &node_x, vector<int> &parents, vector<int> &n_states) {
  if(parents.empty()) {
...
float localBDeuscore_PC(const vector<vector<int>> &data, int &node_x, vector<int> &parents, double &ESS, vector<int> &n_states) {
...
bool ci_test_PC(const vector<vector<int>> &data, int &node_x, int &node_y, vector<int> &Z, double &ESS, vector<int> &n_states) {
...
void orientation(PDAG &Gall, const vector<vector<int>> &data, double &ESS, vector<int> &n_states) {
  /*
...
PDAG PCsearch(const vector<vector<int>> &data, PDAG &Gall, double &ESS, vector<int> &n_states) {
